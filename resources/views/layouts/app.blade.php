...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        <header class="flex items-center justify-between px-8 py-4">
            ...
            @endif
                <a href="">
                <img src="{{ asset('img/img_avatar1.jpg') }}" alt="avatar" class="w-10 h-10 rounded-full">
                </a>
            </div>
        </header>
        ...
        <main class="container mx-auto max-w-custom flex">
            <div class="w-70 mr-5">
               Add idea form goes here. Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi architecto asperiores odit in quo atque eveniet quibusdam quidem modi voluptate dolore aspernatur, corrupti eius aperiam eos sapiente, enim nihil. Sit repellendus molestias magni consectetur minima ullam officiis quo asperiores tempora?
            </div>
            <div class="w-175">
